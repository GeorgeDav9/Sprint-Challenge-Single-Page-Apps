...
> Answer:  Client side routing allows us to reload a page without doing a server request. The page does not refresh and data is displayed without reload. The application process is faster
